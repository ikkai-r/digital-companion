...
app.post("/api/reset", (req, res) => {
    players = [[], [], [], []]
    buffs = [[], [], [], []]
    res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send("Reset successful!")
})

app.get("/api/view/:player", (req, res) => {
    const player = req.params.player
    if (player < 1 || player > 4) {
        res.status(400).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send("Invalid player number!")
    } else {
        res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send({ parts: players[player - 1], stats: getStats(player), buffs: getBuffs(player) })
    }
})
...
app.get("/api/view_parts/:player", (req, res) => {
    ...
    if (player < 1 || player > 4) {
        ...
        res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send(players[player - 1])
    }
});
...
app.get("/api/view_all_stats", (req, res) => {
    ...
    res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send(allStats)
})
...
app.get("/api/search_part/:id", (req, res) => {
    ...
    if (!parts) {
        res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send([])
    } else {
        res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send(parts)
    }
});
...
app.post("/api/add/:player/:part", (req, res) => {
    ...
    if (player < 1 || player > 4) {
        ...
        if (!partObj) {
            res.status(400).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send("Invalid part ID!")
        } else {
            players[player - 1].push(partObj)
            res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send("Part added!")
        }
    }
});
...
app.delete("/api/remove/:player/:part", (req, res) => {
    ...
    if (player < 1 || player > 4) {
        ...
        if (!partObj) {
            ...
            if (index === -1) {
                res.status(400).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send("Part not found!")
            } else {
                players[player - 1].splice(index, 1)
                res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send("Part removed!")
            }
        }
    }
});
...
app.post("/api/buff/:player/:stat/:buff/:duration", (req, res) => {
    ...
    if (player < 1 || player > 4) {
        ...
        res.status(400).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send("Invalid stat!")
    } else if (isNaN(buff) || isNaN(duration)) {
        res.status(400).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send("Buff and duration must be numbers!")
    } else {
        addBuff(player, stat, buff, duration)
        res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send("Buff added!")
    }
});
...
app.get("/api/event/:player/:stat", (req, res) => {
    ...
    if (player < 1 || player > 4) {
        ...
        if(stat === "none") {
            res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send({roll})
        } else {
...
app.post("/api/battle/:player1/:player2", (req, res) => {
    ...
    if (player1 < 1 || player1 > 4 || player2 < 1 || player2 > 4) {
        ...
        useBuff(player1)
        useBuff(player2)
        res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send(result)
    }
});
...
app.get("/api/move/:player", (req, res) => {
    ...
    if (player < 1 || player > 4) {
        ...
        res.status(200).setHeader('Access-Control-Allow-Origin', 'https://digital-companion-as4hrsmct-ikkairs-projects.vercel.app').send({number})
    }
});
